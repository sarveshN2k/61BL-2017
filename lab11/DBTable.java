...
<<<<<<< HEAD
        ...
        //Collections.sort(list, (a,b) -> getter.apply(a).compareTo(getter.apply(b)));
        //return list;
...
<<<<<<< HEAD
        DBTable<R> newlst = new DBTable<R>();
        this.entries.stream().forEach(t -> newlst.add(getter.apply(t)));
        return newlst;
    }
