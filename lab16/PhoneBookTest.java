...
public class PhoneBookTest extends TestCase {
	...
	public void testCanAddAndGet() {
		...
		PhoneNumber expected1 = new PhoneNumber("5105551234");

		myBook.addEntry(person1, num1);
		PhoneNumber numReturned = (PhoneNumber) myBook.getNumber(person1);
	...
	public void testCanChangeNumber() {
		...
		PhoneNumber expected2 = new PhoneNumber("5105551235");
