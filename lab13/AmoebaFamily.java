...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba> {
    ...
    public void makeNamesLowercase() {
        ...
        this.root.name = this.root.name.toLowerCase();
        for (Amoeba child : this.root.children) {
    ...
    public String longestName() {
        ...
        if (root == null) {
            ...
            String longest = this.root.name;
            for (Amoeba child : this.root.children) {
                String childLongest = child.longestName(longest);
...
<<<<<<< HEAD
        ...
        /*
        public Stack<Amoeba> fringe = new Stack<>();
        */

        public Queue<Amoeba> queue = new LinkedList<>();
        ...
        public Amoeba next() {
            ...
            Stack<Amoeba> temp = new Stack<>();
            for (Amoeba a : node.children){
                temp.add(a);
            }
            while (temp.isEmpty()) {
                this.fringe.add(temp.pop());
            }
            return node;
            /*
            Amoeba top = fringe.pop();
            Stack<Amoeba> temp = new Stack<>();
            for (Amoeba child : top.children) {
                temp.add(child);
            }
            while (!temp.isEmpty()) {
                this.fringe.add(temp.pop());
    ...
    public static class Amoeba {
        ...
        public void makeNamesLowercase() {
            ...
            for (Amoeba child : this.children) {
        ...
        public void replaceName(String oldName, String newName) {
            if (this.name == oldName) {
                ...
                for (Amoeba child : this.children) {
                    child.replaceName(oldName,newName);
                }
            }
        }
        ...
        public String longestName(String longestYet) {
            String longest = longestYet; // com
            if (this.name.length() > longest.length()) {
                longest = this.name;
            }
            for (Amoeba child : this.children) {
                String childLongest = child.longestName(longest);
